...
results_out = f"{output_prefix}_strategy_comparison_all8.csv"
...
def plot_equity_curves(results):
    ...
    plt.tight_layout()
    out_name = f"{output_prefix}_equity_curves.png"
...
def plot_performance_comparison(results):
    ...
    plt.tight_layout()
    out_name = f"{output_prefix}_performance_comparison.png"
    plt.savefig(out_name, dpi=150, bbox_inches='tight')
    print(f"📊 Saved: {out_name}")
    plt.close()
...
def plot_drawdown_curves(results):
    ...
    plt.tight_layout()
    out_name = f"{output_prefix}_drawdown_curves.png"
    plt.savefig(out_name, dpi=150, bbox_inches='tight')
    print(f"📊 Saved: {out_name}")
    plt.close()
...
def plot_cumulative_pnl_distribution(results):
    ...
    plt.tight_layout()
    out_name = f"{output_prefix}_cumulative_pnl.png"
    plt.savefig(out_name, dpi=150, bbox_inches='tight')
    print(f"📊 Saved: {out_name}")
    plt.close()
...
def plot_summary_dashboard(results):
    ...
    out_name = f"{output_prefix}_backtest_dashboard.png"
    plt.savefig(out_name, dpi=150, bbox_inches='tight')
    print(f"📊 Saved: {out_name}")
    plt.close()
...
print(f"   - {output_prefix}_equity_curves.png")
print(f"   - {output_prefix}_performance_comparison.png")
print(f"   - {output_prefix}_drawdown_curves.png")
print(f"   - {output_prefix}_cumulative_pnl.png")
print(f"   - {output_prefix}_backtest_dashboard.png")
