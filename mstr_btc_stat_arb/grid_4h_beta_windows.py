...
def run_one_window(window, end_ms):
    cmd = [
        PYTHON,
        str(BACKTEST_SCRIPT),
        "--asset",
...
def main():
    ...
    for w in WINDOWS:
        run_one_window(w, end_ms)

        metrics_path = BASE / "xyz:mstr_4h_rolling_beta_metrics.json"
        signals_path = BASE / "xyz:mstr_4h_rolling_beta_signals.csv"
        report_path = BASE / "xyz:mstr_4h_rolling_beta_report.md"
